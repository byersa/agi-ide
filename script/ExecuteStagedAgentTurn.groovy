...
if (mcpTool && !mcpTool.trim().isEmpty()) {
    ...
    ec.logger.info("🛠️ [ExecuteStagedAgentTurn] Direct MCP tool execution: ${cleanToolName}")
...
// =============================================================================
// 3. Resolve Selected Archetype Resources via agi-ai
// =============================================================================
...
// =============================================================================
// 5. Invoke agi-ai Headless Proxy Service
// =============================================================================
Map proxyParams = [
...
// =============================================================================
if (parsed?.files instanceof List && !parsed.files.isEmpty()) {
    ...
    if (context.mode != 'plan' && finalUri && (finalXml || bufferJson)) {
        ...
        try {
            ...
            ec.logger.warn("⚠️ Could not register AgiArtifact: ${artEx.message}")
        }
    }
